#!/usr/bin/env python3
"""
Script to update the client secret in the .env file.

This script reads the current .env file, updates the client secret values,
...
def main():
    ...
    # Prompt for the new client secret
